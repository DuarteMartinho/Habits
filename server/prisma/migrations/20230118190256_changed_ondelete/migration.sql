...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_day_id_fkey" FOREIGN KEY ("day_id") REFERENCES "day" ("id") ON DELETE NO ACTION ON UPDATE CASCADE,
...
CREATE TABLE "new_habit_week_days" (
    ...
    CONSTRAINT "habit_week_days_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "habits" ("id") ON DELETE NO ACTION ON UPDATE CASCADE
);
